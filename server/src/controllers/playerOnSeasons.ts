...
const extractPlayerOnSeasonData = (req: Request, seasonId?: number, playerId?: number) => {
  const data: any = {
...
const getPlayerOnSeasons = async (req: Request, res: Response, next: NextFunction) => {
...
const getPlayerOnSeason = async (req: Request, res: Response, next: NextFunction) => {
  const seasonId: number = +req.params.seasonId;
...
const updatePlayerOnSeason = async (req: Request, res: Response, next: NextFunction) => {
  const seasonId: number = +req.params.seasonId;
  const playerId: number = +req.params.playerId;
  const playerOnSeason = await prismaClient.playerOnSeason.findUnique({
    where: { playerId_seasonId: { playerId: playerId, seasonId: seasonId } }
...
const deletePlayerOnSeason = async (req: Request, res: Response, next: NextFunction) => {
  const seasonId: number = +req.params.seasonId;
  const playerId: number = +req.params.playerId;
...
const addPlayerOnSeason = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const playerOnSeason = await prismaClient.playerOnSeason.create({
      data: extractPlayerOnSeasonData(req, +req.body.seasonId, playerId)
    });
...
export default { getPlayerOnSeasons, getPlayerOnSeason, updatePlayerOnSeason, deletePlayerOnSeason, addPlayerOnSeason };
